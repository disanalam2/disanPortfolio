    ...
    <footer className="site-footer">
      <div className="footer-container container">
        ...
        <div className="social-links" aria-label="Social links">
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path d="M2.25 5.5A2.75 2.75 0 0 1 5 2.75h14a2.75 2.75 0 0 1 2.75 2.75v13.5A2.75 2.75 0 0 1 19 21.5H5A2.75 2.75 0 0 1 2.25 18.75V5.5Zm1.5 0v13.25c0 .69.56 1.25 1.25 1.25h13.5c.69 0 1.25-.56 1.25-1.25V5.5l-8.25 5.63L3.75 5.5Zm1.97-.75 6.03 4.12 6.03-4.12H4.22Z" />
            </svg>
          </a>
        </div>
      </div>
